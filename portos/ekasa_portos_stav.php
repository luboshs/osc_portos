<?php
   ...
   // spracovanie výstupov do hlásení stavu   
                        ...
                        if ($chyba_spojenie != '') {
                                $hlasenie .="<br />Detail spojenia: ".htmlspecialchars($chyba_spojenie, ENT_QUOTES, 'UTF-8');
                        }
                        if ($chyba_tlaciaren != '') {
                                $hlasenie .="<br />Detail tlačiarne: ".htmlspecialchars($chyba_tlaciaren, ENT_QUOTES, 'UTF-8');
                        }
                        if (isset($GLOBALS['portos_ip_warning']) && $GLOBALS['portos_ip_warning'] != '') {
                                $hlasenie .="<br /><b>Upozornenie:</b> ".htmlspecialchars($GLOBALS['portos_ip_warning'], ENT_QUOTES, 'UTF-8');
                        }

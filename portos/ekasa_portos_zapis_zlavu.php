<?php
//  *****************************************************************  
//  ******* DEPRECATED: Tento skript sa už nepoužíva ********
//  *****************************************************************      
//  * Zľava sa teraz aplikuje na jednotlivé položky v ekasa_polozky.php
//  * a nie je potrebné ju zapisovať separátne do databázy
//  *****************************************************************
//  ****** verzia 2.00 (refaktorizovaná) ****************************
//  *****************************************************************
//  
//  STARÉ POZNÁMKY (pre históriu):
//  - nie je dorobená funkcionalita bločku na email (na okne)
//  
//  /* STARÝ KÓD (už sa nepoužíva):

     ...
     // zistenie POST / GET dát
                ...
                // zápis bločka do tabuľky    - chýba koniec bločka
                   ...
                   */
                   ...
                   /*   
                       ...
                       $komentar = "ekasa / Portos - objednávka uzavretá a vyúčtovaná pokladničným bločkom v celkovej sume ".$medzisucet." €"."\n\nPlatidlá:\nHotovosť = ".$hotovost_sql."\nKarta= ".$karta_sql."\nID bločka = ".(int)$blocekID;
        ...
        switch ($akcia) { 
                ...
                default:
                        ...
                        if ($order->customer['zlava']>0) {echo '<b><font color="red">Klient má nastavenú zľavu '.$order->customer['zlava'].'%</font></b>';}
                        echo '</td>';
                        echo '<td>';
                        if ( $cID > 0)   {
